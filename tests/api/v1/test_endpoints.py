...
def make_client(mock_service: MagicMock):
    """
    override get_db (so no DB is touched) and patch AnalyticsService
    so every endpoint uses mock_service instead of a real query.
    """
    mock_db = MagicMock()
